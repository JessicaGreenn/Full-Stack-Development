...
public class MapsFragment2 extends Fragment {
    ...
    private OnMapReadyCallback callback = new OnMapReadyCallback() {
        ...
        public void onMapReady(GoogleMap googleMap) {
            LatLng business = new LatLng(lat, lng);
            googleMap.addMarker(new MarkerOptions().position(business).title(name));
            googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(business, 15));
        }
    };
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        name = myIntent.getStringExtra("businessName");
